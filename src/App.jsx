...
export default function App() {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Hydraulic structure supports flexible roof topped with a wind turbine.",
      img: sideviewImg,
    },
    {
      id: 4,
      title: "Flexible Roof",
      desc: "Roof adapts to wind patterns, optimizing airflow for the turbine.",
      img: topviewImg,
    },
    {
      id: 5,
      title: "Energy-Generating Recreation",
      desc: "Cycling and treadmill desks help generate energy while you stay active.",
      img: inside1Img,
    },
    {
      id: 6,
    ...
    {
      id: 7,
      title: "Car-Free Transport",
      desc: "Public transport inside the mall reduces carbon footprint and traffic.",
      img: tranviewImg,
    }
  ];
    ...
    >
      ...
      <section id="motivation" className="py-16 px-10 bg-white rounded-xl max-w-5xl mx-auto shadow-lg mt-10">
        ...
        <p className="mt-6 text-center text-gray-700">
          LivMal demonstrates how architecture, climate-adaptive design, and sustainability can create a space that is immersive, inspiring, and alive.
        </p>
      </section>
